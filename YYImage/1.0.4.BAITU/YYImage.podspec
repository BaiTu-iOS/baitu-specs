Pod::Spec.new do |s|
  ...
  s.version      = '1.0.4.BAITU'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = { 'ibireme' => 'ibireme@gmail.com' }
  s.social_media_url = 'http://blog.ibireme.com'
  s.homepage     = 'https://github.com/BaiTu-iOS/YYImage'
  s.platform     = :ios, '6.0'
  s.ios.deployment_target = '6.0'
  s.source       = { :git => 'https://github.com/BaiTu-iOS/YYImage.git', :tag => s.version.to_s }
  ...
  s.subspec 'WebP' do |webp|
    ...
    # The vendored XCFramework targets the minimum iOS version supported by the current Xcode toolchain.
    webp.ios.deployment_target = '12.0'
